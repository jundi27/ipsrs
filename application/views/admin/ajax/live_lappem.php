        ...
        <?php $i = 1; ?>
            <?php foreach ($lappem as $lp) : ?>
                <tr>
                    <td scope="row"><?= $i; ?></td>
                    <td><?= $lp->nama; ?></td>
                    <td><?php $myd=date_create($lp->lpdc); echo date_format($myd, 'd M Y'); ?></td>
                    <td><a href="javascript:;"
                        data-id-hst="<?php echo $lp->hlid ?>"
                        data-toggle="modal" data-target="#detailHistoryLaporan" class="badge badge-primary">Detail</a>
